...
@section('content')
    ...
    <div class="col-sm-20 window">
        ...
        <div id="page-header" class="col-sm-23 ml-4">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h1>Solicitor Performance<p id="solicitorId" class="hidden">{{ $solicitor->slug }}</p></h1>
                </div>

                <div class="col-sm-12">
                    <a href="/solicitors/{{ $solicitor->slug }}/office/create">
                        <button class="success-button col-sm-10 float-right">Add Office</button>
                    </a>
                </div>
            </div>
...
{{--                            <div class="col-sm-12">
                                <div class="notification-circle instructions-kpi" id="instructed">

                                    <p>
                                        <span id="instructionsCount"></span>
                                        <br>Capacity remaining
                                    </p>
            ...
            <div class="panel col-sm-23">
                ...
                <div class="panel-body">
                    <table class="table table-bordered" id="solicitorStatsTable">
                        <thead>
                        <tr>
                            <th>Office</th>
                            <th>Pipeline</th>
