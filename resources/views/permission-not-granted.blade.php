...
<body>
<!--mian-content-->
<h1>NO PERMISSIONS GRANTED</h1>
<div class="main-wthree">
	{{--<h3>NO PERMISSIONS GRANTED</h3>--}}
	<p><span class="sub-agileinfo">Sorry! </span>You don't have the correct permissions to access this page.</p>
	<br>
	<!--form-->
...
<div class="copyright-w3-agile">
	<p> © <?php echo date("Y"); ?> The Conveyancing Partnership. All rights reserved | Design by <a href="http://w3layouts.com/" target="_blank">W3layouts</a></p>
</div>
<!-- //copyright -->
