...
class CreateTcpMessagesTable extends Migration
{
    /**
    ...
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->index(["associated_id"], 'idx_tcp_messages__associated_id');

            $table->index(["date_sent"], 'idx_tcp_messages__date_sent');
        });
    }
